...
function Restaurants() {
  ...
  return (
    <div className=" bg-[rgb(230,240,240)]">
      <h1 className="text-4xl font-bold text-center py-4">Restaurants</h1>
      <div className="py-10 flex justify-center">
        
        <input
          type="text"
          placeholder="Search restaurant....."
          className="border-black border-[1px] outline-none p-2 rounded-lg"
          value={search}
      ...
      <div className=" flex flex-wrap justify-center items-center gap-8">
        {data
          ...
          .map((card) => (
            <div
              key={card._id.$oid}
              className="w-96 border bg-white overflow-hidden hover:cursor-pointer hover:scale-105 duration-300 hover:shadow-2xl shadow-lg rounded-xl pt-4"
            >
